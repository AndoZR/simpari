...
<script>
    $(document).ready(function () {
        let url = '{{ route("managePemungut.index") }}';
        var idPemungut;
        ...
        $('#form-pemungut').submit(function(e) {
            ...
            if(idPemungut !== undefined){
                url = "{{ route('managePemungut.update', ['id' => ':id']) }}";
                url = url.replace(':id', idPemungut)
            }else{
                url = "{{ route('managePemungut.tambah') }}";
            }
        ...
        $('#table-pemungut tbody').on('click', '.btn-hapus', function() {
            var data = tablePemungut.row($(this).parents('tr')).data();
            let urlDestroy = "{{ route('managePemungut.hapus', ['id' => ':id']) }}"
        ...
        $('#table-pemungut tbody').on('click', '.btn-plotting', function() {
            ...
            let urlPlotting = '{{ route("managePemungut.plotting.index", ":idPemungut") }}';
            ...
            $.ajax({
                url: "{{ route('managePemungut.plotting.getDesa') }}",
                type: "GET",
                success: function(data) {
        ...
        $('#desa').on('change', function() {
            ...
            if(desaId) {
                $.ajax({
                    url: `{{ Route('managePemungut.plotting.getMasyarakat', ['desaId'=> ':desaId']) }}`.replace(':desaId', desaId),
                    type: 'GET',
                    success: function(response) {
        ...
        $('#form-plotting').submit(function(e) {
            ...
            url = "{{ route('managePemungut.plotting.sendPlot', ['idPemungut' => ':idPemungut']) }}";
        ...
        $('#table-plotting tbody').on('click', '.btn-hapus-plotting', function() {
            ...
            let urlDestroy = "{{ route('managePemungut.plotting.hapusPlotting', ['idMasyarakat' => ':idMasyarakat']) }}"
